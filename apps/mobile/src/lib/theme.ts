...
export const lightTheme = {
  ...
  glass: {
    standardBorder: 'rgba(255, 255, 255, 0.96)',
    nativeStandardBorder: 'rgba(255, 255, 255, 0.72)',
    mutedBorder: 'rgba(255, 255, 255, 0.88)',
    nativeMutedBorder: 'rgba(255, 255, 255, 0.6)',
    accentBorder: 'rgba(255, 255, 255, 0.9)',
    nativeAccentBorder: 'rgba(255, 255, 255, 0.62)',
    fallbackBorder: 'rgba(255, 255, 255, 0.98)',
    fallbackBorderStrong: 'rgba(255, 255, 255, 1)',
    ...
    flatDepth: 'rgba(15, 23, 40, 0.055)',
    fallbackDepth: 'rgba(15, 23, 40, 0.07)',
    fallbackDepthOpacity: 1,
    innerEdgeOpacity: 0.9,
    softInnerEdgeOpacity: 0.78,
    discSheen: 'rgba(255, 255, 255, 0.76)',
    webShadow:
      '0 0 0 1px rgba(255, 255, 255, 0.94), 0 24px 42px -24px rgba(15, 23, 40, 0.34), 0 8px 18px -16px rgba(15, 23, 40, 0.2), inset 0 1px 0 rgba(255, 255, 255, 0.96), inset 0 -1px 0 rgba(15, 23, 40, 0.05)',
    flatWebShadow:
      '0 0 0 1px rgba(255, 255, 255, 0.92), 0 20px 34px -24px rgba(15, 23, 40, 0.3), 0 7px 16px -15px rgba(15, 23, 40, 0.18), inset 0 1px 0 rgba(255, 255, 255, 0.94), inset 0 -1px 0 rgba(15, 23, 40, 0.045)',
    flatSoftWebShadow:
      '0 0 0 1px rgba(255, 255, 255, 0.9), 0 18px 30px -23px rgba(15, 23, 40, 0.28), 0 6px 14px -14px rgba(15, 23, 40, 0.16), inset 0 1px 0 rgba(255, 255, 255, 0.9)',
    shadowColor: '#0f1728',
    shadowOpacity: 0.16,
    shadowRadius: 22,
    flatSoftShadowOpacity: 0.14,
    flatSoftShadowRadius: 18,
    ...
    homeBorder: 'rgba(255, 255, 255, 0.96)',
    homeFabBorder: 'rgba(255, 255, 255, 0.98)',
    homeFabGlassTint: 'rgba(37, 99, 235, 0.035)',
    homeFabInnerGlow: 'rgba(37, 99, 235, 0.1)',
    homeFabInnerWarmGlow: 'rgba(245, 164, 0, 0.16)',
    homeFabInnerTopGlow: 'rgba(255, 255, 255, 0.26)',
    homeFabHighlightEdge: 'rgba(255, 255, 255, 0.92)',
    homeFabWarmEdge: 'rgba(245, 164, 0, 0.16)',
    homeFabSpecular: 'rgba(255, 255, 255, 0.72)',
    homeFabWarmSpecular: 'rgba(255, 214, 112, 0.34)',
...
export const darkTheme = {
  ...
  glass: {
    ...
    homeBorder: 'rgba(226, 232, 240, 0.06)',
    homeFabBorder: 'rgba(226, 232, 240, 0.07)',
    homeFabGlassTint: 'rgba(96, 165, 250, 0.06)',
    homeFabInnerGlow: 'rgba(96, 165, 250, 0.08)',
    homeFabInnerWarmGlow: 'rgba(251, 191, 36, 0.08)',
    homeFabInnerTopGlow: 'rgba(255, 255, 255, 0.12)',
    homeFabHighlightEdge: 'rgba(255, 255, 255, 0.5)',
    homeFabWarmEdge: 'rgba(251, 191, 36, 0.12)',
    homeFabSpecular: 'rgba(255, 255, 255, 0.34)',
    homeFabWarmSpecular: 'rgba(251, 191, 36, 0.16)',
