...
export const lightTheme = {
  ...
  glass: {
    ...
    homeFabEdgeGlow: 'rgba(37, 99, 235, 0.32)',
    homeFabEdgeRing: 'rgba(29, 78, 216, 0.58)',
    homeFabOuterGlow: 'rgba(37, 99, 235, 0.34)',
    homeFabWarmGlow: 'rgba(245, 164, 0, 0.3)',
    homeFabHighlightEdge: 'rgba(255, 255, 255, 0.74)',
    homeFabWarmEdge: 'rgba(245, 164, 0, 0.38)',
...
export const darkTheme = {
  ...
  glass: {
    ...
    homeFabEdgeGlow: 'rgba(96, 165, 250, 0.18)',
    homeFabEdgeRing: 'rgba(96, 165, 250, 0.36)',
    homeFabOuterGlow: 'rgba(96, 165, 250, 0.24)',
    homeFabWarmGlow: 'rgba(251, 191, 36, 0.18)',
    homeFabHighlightEdge: 'rgba(255, 255, 255, 0.42)',
    homeFabWarmEdge: 'rgba(251, 191, 36, 0.24)',
