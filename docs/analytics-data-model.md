...
`cleanup_supabase_usage_retention()` runs nightly at 03:35 UTC and keeps raw
tables bounded after analytics facts have been materialized:

- `cron.job_run_details`: 7 days.
- `net._http_response`: 2 days.
- `product_events`: 180 days.
- `app_sessions`: 180 days.
