  ...
  public: {
    Tables: {
      ...
      push_notification_events: {
        ...
        Relationships: [
          {
            foreignKeyName: 'push_notification_events_recipient_user_id_fkey';
      ...
      settlement_edge_reservations: {
        ...
        Relationships: [
          {
            foreignKeyName: 'settlement_edge_reservations_creditor_user_id_fkey';
            columns: ['creditor_user_id'];
            isOneToOne: false;
            referencedRelation: 'user_profiles';
            referencedColumns: ['id'];
          ...
          {
            foreignKeyName: 'settlement_edge_reservations_debtor_user_id_fkey';
            columns: ['debtor_user_id'];
            isOneToOne: false;
            referencedRelation: 'user_profiles';
            referencedColumns: ['id'];
          ...
          {
            foreignKeyName: 'settlement_edge_reservations_user_high_id_fkey';
            columns: ['user_high_id'];
            isOneToOne: false;
            referencedRelation: 'user_profiles';
            referencedColumns: ['id'];
          ...
          {
            foreignKeyName: 'settlement_edge_reservations_user_low_id_fkey';
            columns: ['user_low_id'];
            isOneToOne: false;
            referencedRelation: 'user_profiles';
            referencedColumns: ['id'];
      ...
      settlement_proposal_participants: {
        ...
        Relationships: [
          {
            foreignKeyName: 'settlement_proposal_participan_carried_from_participant_id_fkey';
      ...
      settlement_proposals: {
        Row: {
          ...
          stale_reason: Database['public']['Enums']['settlement_stale_reason'] | null;
      ...
      trusted_devices: {
        Row: {
          ...
          platform: string;
          revoked_at: string | null;
          trust_proof_at: string | null;
          trust_proof_method: string | null;
          trust_state: string;
      ...
      user_profiles: {
        Row: {
          ...
          account_invite_claim_expires_at: string | null;
          account_invite_claimed_at: string | null;
          activated_at: string | null;
          ...
          pending_account_invite_delivery_id: string | null;
          pending_account_invite_id: string | null;
          phone_country_calling_code: string | null;
          phone_country_iso2: string | null;
          phone_e164: string | null;
          phone_identity_legacy_at: string | null;
          phone_national_number: string | null;
          phone_verified_at: string | null;
          updated_at: string;
          welcome_email_last_error: string | null;
          welcome_email_lease_id: string | null;
    ...
    Views: {
      ...
      v_friendship_invite_deliveries_live: {
        Row: {
          channel: Database['public']['Enums']['friendship_invite_channel'] | null;
          claimed_at: string | null;
          claimed_by_user_id: string | null;
          created_at: string | null;
          expires_at: string | null;
          ...
          revoked_at: string | null;
          source_context: string | null;
          status: Database['public']['Enums']['friendship_invite_delivery_status'] | null;
          updated_at: string | null;
        };
        Insert: {
          channel?: Database['public']['Enums']['friendship_invite_channel'] | null;
      ...
      v_friendship_invites_live: {
        Row: {
          ...
          intended_recipient_phone_label: string | null;
          inviter_user_id: string | null;
          origin_channel: Database['public']['Enums']['friendship_invite_channel'] | null;
          relationship_id: string | null;
          resolution_actor:
            | Database['public']['Enums']['friendship_invite_resolution_actor']
            | null;
      ...
      v_user_profiles_private: {
        Row: {
          account_access_state: Database['public']['Enums']['account_access_state'] | null;
          activated_at: string | null;
          activated_via_account_invite_id: string | null;
          avatar_path: string | null;
          created_at: string | null;
    ...
    Functions: {
      ...
      activate_account_from_pending_invite: {
        Args: {
          p_actor_user_id: string;
          p_current_device_id: string;
          p_current_session_id: string;
      ...
      active_settlement_edge_reservations: {
        Args: never;
        Returns: {
          amount_minor: number;
          created_at: string;
      ...
      claim_account_invite_for_current_user: {
      ...
      claim_push_notification_events: {
      ...
      claim_welcome_email_delivery_v2: {
        Args: { p_actor_user_id: string };
        Returns: {
          display_name: string;
          email: string;
      ...
      cleanup_new_user_operational_state: { Args: never; Returns: Json };
      ...
      compute_available_graph_component_snapshot: {
        Args: {
      ...
      compute_available_graph_component_snapshot_hash: {
        Args: {
          p_currency_code?: string;
          p_left_user_id: string;
          p_right_user_id: string;
      ...
      compute_available_graph_snapshot_hash: { Args: never; Returns: string };
      ...
      consume_cycle_settlement_reservations: {
        Args: { p_proposal_id: string };
        Returns: number;
      };
      ...
      cycle_settlement_reservation_rows: {
        Args: { p_currency_code?: string; p_movements_json: Json };
        Returns: {
          amount_minor: number;
          creditor_user_id: string;
          currency_code: string;
      ...
      enqueue_graph_cycle_jobs_for_proposal_reservations: {
        Args: {
          p_actor_user_id: string;
          p_anchor_user_id: string;
          p_proposal_id: string;
      ...
      get_current_user_private_profile: {
        Args: never;
        Returns: {
          account_access_state: Database['public']['Enums']['account_access_state'];
          account_invite_claim_expires_at: string;
          account_invite_claimed_at: string;
          activated_at: string;
          activated_via_account_invite_id: string;
          avatar_path: string;
          created_at: string;
          deleted_at: string;
          ...
          pending_account_invite_delivery_id: string;
          pending_account_invite_id: string;
          phone_country_calling_code: string;
          phone_country_iso2: string;
          phone_e164: string;
          phone_identity_legacy_at: string;
          phone_national_number: string;
          phone_verified_at: string;
          updated_at: string;
          welcome_email_last_error: string;
          welcome_email_lease_id: string;
          welcome_email_queued_at: string;
      ...
      lock_cycle_settlement_reservation_pairs: {
        Args: {
          p_currency_code?: string;
          p_extra_proposal_id?: string;
          p_movements_json: Json;
        };
        Returns: undefined;
      };
      ...
      mark_profile_phone_verified: {
        Args: { p_actor_user_id: string; p_phone_e164: string };
        Returns: string;
      };
      mark_welcome_email_sent_v2: {
      ...
      reconcile_all_reservation_capacity: { Args: never; Returns: number };
      reconcile_pair_reservation_capacity: {
        Args: {
          p_currency_code?: string;
          p_user_high_id: string;
          p_user_low_id: string;
        };
        Returns: number;
      };
      reconcile_touched_reservation_capacity: {
        Args: { p_touched_user_ids: string[] };
        Returns: number;
      };
      ...
      release_cycle_settlement_reservations: {
        Args: { p_proposal_id: string; p_reason?: string };
        Returns: number;
      };
      release_stale_account_invite_claims: {
        Args: { p_limit?: number };
        Returns: number;
      };
      release_stale_account_invite_claim_for_phone: {
        Args: { p_inviter_user_id: string; p_phone_e164: string };
        Returns: number;
      };
      release_welcome_email_delivery_v2: {
        Args: { p_actor_user_id: string; p_error: string; p_lease_id: string };
        Returns: boolean;
      };
      ...
      reserve_cycle_settlement_edges: {
        Args: {
          p_currency_code?: string;
          p_movements_json: Json;
          p_proposal_id: string;
          p_replaces_proposal_id?: string;
        };
        Returns: number;
      };
      ...
      validate_cycle_reservation_capacity: {
        Args: {
          p_currency_code?: string;
      ...
      validate_cycle_reservation_capacity_for_execution: {
        Args: { p_proposal_id: string };
        Returns: boolean;
      };
    ...
    Enums: {
      ...
      account_invite_status:
        ...
        | 'canceled'
        | 'expired';
      friendship_invite_channel: 'internal' | 'whatsapp' | 'link' | 'qr' | 'remote';
      friendship_invite_delivery_status: 'issued' | 'claimed' | 'revoked' | 'expired';
      ...
      friendship_invite_status:
        ...
        | 'canceled'
        | 'expired';
      graph_cycle_job_status: 'pending' | 'processing' | 'completed' | 'failed' | 'superseded';
      ...
      request_status: 'pending' | 'accepted' | 'rejected' | 'amended' | 'canceled' | 'expired';
