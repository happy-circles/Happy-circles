...
export const analyticsMetadataSchema = z
  .object({
    ...
    cacheHit: analyticsMetadataValueSchema.optional(),
    cacheState: analyticsMetadataValueSchema.optional(),
    cachedAgeMs: analyticsMetadataValueSchema.optional(),
    durationMs: analyticsMetadataValueSchema.optional(),
    ...
    networkStatus: analyticsMetadataValueSchema.optional(),
    phase: analyticsMetadataValueSchema.optional(),
    ...
    snapshotVersion: analyticsMetadataValueSchema.optional(),
    source: analyticsMetadataValueSchema.optional(),
    startKind: analyticsMetadataValueSchema.optional(),
